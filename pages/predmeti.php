...
print '<i class="fas fa-plus" style="margin-right:.5rem"></i>Novi Predmet';
print '</a>';;
print '</div>';
print '</div>';
...
print '<th class="seup-table-th"><i class="fas fa-paper-plane" style="margin-right:.5rem"></i>Pošiljatelj</th>';
print '<th class="seup-table-th"><i class="fas fa-inbox" style="margin-right:.5rem"></i>Zaprimljeno</th>';
...
if (count($predmeti)) {
    ...
    print '<i class="fas fa-plus" style="margin-right:.5rem"></i>Kreiraj prvi predmet';
    print '</button>';
    print '</div>';
    print '</td>';
    print '</tr>';
...
print '<h5 class="seup-modal-title"><i class="fas fa-archive" style="margin-right:.5rem"></i>Arhiviranje Predmeta</h5>';
...
print '<label for="arhivskaGradiva" class="seup-label"><i class="fas fa-archive" style="margin-right:.5rem"></i>Vrsta arhivske građe *</label>';
...
print '<div class="seup-form-group">';
print '<label class="seup-label"><i class="fas fa-clock" style="margin-right:.5rem"></i>Postupak po isteku roka čuvanja *</label>';
...
print '<i class="fas fa-archive" style="margin-right:.5rem"></i>Arhiviraj';
print '</button>';
print '</div>';
print '</div>';
print '</div>';
