...
$head = array();
$h = 0;
$head[$h][0] = dol_buildpath('/custom/seup/pages/o_programu.php', 1);
...
.seup-admin-header { margin-bottom: var(--space-5); }
.seup-info-grid { gap: var(--space-5); }
.seup-contact-grid { gap: var(--space-5); }
.seup-section-title { letter-spacing: .2px; }
.seup-admin-title { letter-spacing: .3px; }
.seup-info-card .seup-info-icon { opacity: .95; }

/* --- Spacing & alignment polish --- */
.seup-about-container { padding: var(--space-5); }

.seup-hero { padding: var(--space-6) var(--space-5) var(--space-4); }
.seup-hero-inner { display: flex; align-items: center; gap: var(--space-4); }
.seup-hero-logo { height: 54px; max-width: 260px; object-fit: contain; }
.seup-hero-title { margin: 0 0 var(--space-1) 0; }
.seup-hero-subtitle { margin: 0; opacity: .9; }
...
.seup-section-title { margin: 0; }

.seup-info-grid { gap: var(--space-5); }
.seup-contact-grid { gap: var(--space-5); }

/* Cards: add inner spacing for icon & text */
.seup-info-card { padding: var(--space-5); }
.seup-info-icon { margin-right: var(--space-2); }

/* Push content a bit from the extreme left */
.seup-admin-header-content, .seup-about-container, .seup-admin-tabs { padding-left: var(--space-2); padding-right: var(--space-2); }
